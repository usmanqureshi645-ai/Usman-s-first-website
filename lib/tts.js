...
const PERSONA_VOICES = {
  ...
  'Marcus Lee':         { voice: 'Stephen',  language: 'en-US' }, // US male, distinct from Brian/Matthew
  ...
  'Charlotte Sinclair': { voice: 'Salli',    language: 'en-US' }, // US female (Eleanor's old voice — user requested)
  'Eleanor Hughes':     { voice: 'Joanna',   language: 'en-US' }, // US female, emotion-capable (bonus upgrade)
...
const PERSONA_VOICE_SETTINGS = {
  ...
  'Marcus Lee':         { rate: '1.03', loudness: '+8dB' },  // measured, composed
  'Elena Rossi':        { rate: '1.15', loudness: '+9dB' },  // most energetic
  'James Carter':       { rate: '1.12', loudness: '+8dB' },  // fast-paced, emotion-capable
