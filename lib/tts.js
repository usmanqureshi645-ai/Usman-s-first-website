...
const PERSONA_VOICE_SETTINGS = {
  ...
  'Amelia Hartley':     { rate: '1.15', loudness: '+9dB' },  // upbeat, warm
  'Marcus Lee':         { rate: '1.15', loudness: '+10dB' }, // high energy, punchy
  'Elena Rossi':        { rate: '1.15', loudness: '+9dB' },  // most energetic
  'James Carter':       { rate: '1.15', loudness: '+9dB' },  // high energy, punchy
  'Charlotte Sinclair': { rate: '1.15', loudness: '+9dB' },  // enthusiastic
  'Eleanor Hughes':     { rate: '1.15', loudness: '+8dB' },  // warm, encouraging
  'Quiz Coach':         { rate: '1.15', loudness: '+9dB' },  // quiz-show energy
