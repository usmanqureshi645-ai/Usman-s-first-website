...
export const BLOG_ARTICLES = [
  ...
  // IFRS 37 / IAS 37 — Provisions
  { file: 'ifrs-37-provisions-contingencies-complete-guide.html', title: 'Complete Guide to Provisions & Contingencies (IAS 37)', topics: ['ias 37', 'provisions', 'contingent liabilities', 'onerous contracts'] },
  ...
  { file: 'goodwill-impairment-ifrs-36-vs-asc-350-deep-dive.html', title: 'Goodwill Impairment: IAS 36 vs ASC 350', topics: ['ias 36', 'asc 350', 'goodwill impairment', 'us gaap'] },
  { file: 'provisions-contingencies-ifrs-37-vs-asc-450-deep-dive.html', title: 'Provisions: IAS 37 vs ASC 450', topics: ['ias 37', 'asc 450', 'provisions', 'us gaap'] },
  { file: 'inventory-valuation-ifrs-2-vs-asc-330-deep-dive.html', title: 'Inventory Valuation: IAS 2 vs ASC 330', topics: ['ias 2', 'asc 330', 'inventory', 'us gaap'] },
  // Audit
