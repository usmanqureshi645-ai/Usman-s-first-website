...
const PERSONA_VOICES = {
  ...
  'Amelia Hartley':     { voice: 'Ruth',     language: 'en-US' }, // US female (distinct from Kimberly)
  'Marcus Lee':         { voice: 'Russell',  language: 'en-AU' }, // Australian male (distinct from UK Brian)
  'Elena Rossi':        { voice: 'Danielle', language: 'en-US' }, // US female (newer 2023 neural voice)
...
const PERSONA_VOICE_SETTINGS = {
  ...
  'Marcus Lee':         { rate: '1.03', loudness: '+8dB' },  // measured, Australian
  'Elena Rossi':        { rate: '1.15', loudness: '+9dB' },  // most energetic
  'James Carter':       { rate: '1.12', loudness: '+8dB' },  // fast-paced, driven
